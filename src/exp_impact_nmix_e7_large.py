...
para1 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-7, n_iter=80000, tau=250, batch_size=1024,
              stepsize_LSVRG=0.01, stepsize_SAGA=0.2, stepsize_NIDS=1.4, nmix_LSVRG=1, nmix_SAGA=1)
##
para2 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-7, n_iter=3000, tau=250, batch_size=1024,
              stepsize_LSVRG=0.5, stepsize_SAGA=888, stepsize_NIDS=1.4, nmix_LSVRG=7, nmix_SAGA=7)
##
para3 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-7, n_iter=500, tau=250, batch_size=1024,
              stepsize_LSVRG=1.7, stepsize_SAGA=888, stepsize_NIDS=1.4, nmix_LSVRG=14, nmix_SAGA=14)

para4 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-7, n_iter=300, tau=250, batch_size=1024,
              stepsize_LSVRG=5.1, stepsize_SAGA=888, stepsize_NIDS=1.4, nmix_LSVRG=28, nmix_SAGA=28)

para5 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-7, n_iter=200, tau=250, batch_size=1024,
              stepsize_LSVRG=5.9, stepsize_SAGA=888, stepsize_NIDS=1.4, nmix_LSVRG=50, nmix_SAGA=50)
# LSVRG is of a poor performance with mix=30, lr=6.4, but a good one when lr > 6.8
...
run_single_exp(optimizers, name='exp_kappa002_e7_nmix')
