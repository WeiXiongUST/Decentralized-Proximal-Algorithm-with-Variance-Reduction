...
para1 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-5, n_iter=4000, tau=250, batch_size=1024,
              stepsize_LSVRG=0.03, stepsize_SAGA=0.05, stepsize_NIDS=0.4, nmix_LSVRG=1, nmix_SAGA=1)

para2 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-5, n_iter=800, tau=250, batch_size=1024,
              stepsize_LSVRG=0.2, stepsize_SAGA=0.2, stepsize_NIDS=0.4, nmix_LSVRG=3, nmix_SAGA=3)

para3 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-5, n_iter=300, tau=250, batch_size=1024,
              stepsize_LSVRG=0.55, stepsize_SAGA=0.55, stepsize_NIDS=0.4, nmix_LSVRG=5, nmix_SAGA=5)

para4 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-5, n_iter=300, tau=250, batch_size=1024,
              stepsize_LSVRG=1.2, stepsize_SAGA=0.8, stepsize_NIDS=0.4, nmix_LSVRG=10, nmix_SAGA=10)

para5 = PARAS(num_agent=20, n=6400, dim=64, lamb1=1/(20*6400), lamb2=6400*1e-5, n_iter=300, tau=250, batch_size=1024,
              stepsize_LSVRG=1.2, stepsize_SAGA=0.9, stepsize_NIDS=0.4, nmix_LSVRG=30, nmix_SAGA=30)
...
run_single_exp(optimizers, name='exp_kappa02_e5_nmix')
